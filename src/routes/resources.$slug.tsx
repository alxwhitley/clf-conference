    ...
    <div className="bg-cream text-dark min-h-screen">
      <article className="pt-32 md:pt-40 pb-24">
        <div className="mx-auto max-w-3xl px-5 md:px-8">
          <div className="flex items-start justify-between gap-4 flex-wrap">
            ...
            {note.pdfUrl && (
              <a
                ...
                download
                className="inline-flex items-center gap-2 px-5 py-3 bg-dark text-cream text-[11px] font-bold uppercase tracking-[0.22em] rounded-[2px] hover:bg-dark-warm"
              >
          ...
          <div className="eyebrow !text-dark/50 mt-10">{note.day}</div>
