...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "New Wave — A Young Adults Gathering" },
      { name: "description", content: "New Wave Ignition is a conference website for young adults and senior leaders, featuring event details and registration." },
      { property: "og:description", content: "New Wave Ignition is a conference website for young adults and senior leaders, featuring event details and registration." },
      { name: "twitter:description", content: "New Wave Ignition is a conference website for young adults and senior leaders, featuring event details and registration." },
